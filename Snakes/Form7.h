...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(372, 117);
			...
			this->label2->Location = System::Drawing::Point(162, 9);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(79, 29);
			this->label2->TabIndex = 1;
			this->label2->Text = L"HELP";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(157, 185);
			...
			this->ClientSize = System::Drawing::Size(393, 220);
